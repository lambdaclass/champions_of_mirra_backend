defmodule ChampionsOfMirra.Accounts.User do
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, ChampionsOfMirra.Repo)
  ...
  """
  def valid_password?(%ChampionsOfMirra.Accounts.User{hashed_password: hashed_password}, password)
