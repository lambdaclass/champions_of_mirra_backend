defmodule ChampionsOfMirraWeb.UserController do
  ...
  def get_opponents(conn, %{"device_client_id" => device_client_id}) do
    ...
    json(conn, Enum.map(opponents, &%{id: &1.id, username: &1.username}))
  end

  def get_user(conn, %{"device_client_id" => device_client_id}) do
    user = ChampionsOfMirra.Accounts.get_user_by_device_client_id(device_client_id)
